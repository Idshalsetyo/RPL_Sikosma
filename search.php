...
<div class="super_container">
	...
	<header class="header">
			...
			<div class="header_list">
				<ul class="d-flex flex-row align-items-center justify-content-start">
					...
					<li class="d-flex flex-row align-items-center justify-content-start">
						...
						<span>+62 82311463002</span>
					</li>
					<!-- Address -->
					<li class="d-flex flex-row align-items-center justify-content-start">
						<div><img src="images/placeholder.svg" alt=""></div>
						<span>JJl. Unsika Raya, no 420 ,Kosambi-Karawang</span>
					</li>
					<!-- Email -->
					<li class="d-flex flex-row align-items-center justify-content-start">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<div class="submit ml-auto"><a href="#">Review Kost</a></div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						...
						<div class="section_title"><h1>Hasil Pencarian</h1></div>
					</div>
				</div>
			</div>
			<div class="row featured_row">
			<?php 
				$cari = $konek->real_escape_string($_GET['src']);
				$query = $konek->query("SELECT akun.id_akun, akun.nama as x, akun.telp, kos.*, kategori.* FROM akun, kos, kategori WHERE akun.id_akun=kos.id_akun AND kos.id_kat=kategori.id_kat AND (kos.nama LIKE '%$cari%' OR kos.jam_tamu LIKE '%$cari%' OR kos.deskripsi LIKE '%$cari%' OR kos.alamat LIKE '%$cari%' OR kos.nama LIKE '%$cari%' OR akun.nama LIKE '%$cari%' OR kategori.nama_kat LIKE '%$cari%')");
