...
<div class="content-pack">
	...
	<?php
		...
		if(isset($_POST['profile'])){
			...
			$akses = isset($_POST['akses']) ? $konek->real_escape_string($_POST['akses']) : 'default';
			if(in_array($akses, array_column($konek->query("SELECT id_akses FROM level")->fetch_all(), 0))) {
				if($_GET['req']=='setakun'){
				...
				echo "<script>alert('Id akses tidak valid')</script>";
			}
		}
	?>
